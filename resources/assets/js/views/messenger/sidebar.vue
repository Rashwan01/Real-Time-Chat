							...
							<div class="tab-content">
								...
								<div class="tab-pane fade" id="members">
									...
									<div class="contacts">
										...
										<div class="list-group" id="contacts" role="tablist">  
											...
											<a href="#" class="filterMembers all online contact" data-toggle="list" v-for=" (list,index) in onlineUserList" :key="index">
								...
								<div id="discussions" class="tab-pane fade active show">
									...
									<div class="discussions">
								 	...
								 	<friend-list v-for=" (friend,index) in friendsList" :key = "index" :data = "friend"></friend-list>		
...
EventBus.$on("userJoin",res=>{
      
 
    
   
})
EventBus.$on("userLeave",res=>{
  

 
})

        axios.post("api/user/friendList",{AuthUser:User.id()}) 
            .then(res=>{
        ...
        this.friendsList.forEach((list,index) => {
